...
function productosCtrl($scope, $rootScope, Productos, $location, DTOptionsBuilder, DTColumnBuilder) {

	$scope.pageClass = 'page-item';
	$rootScope.footer = 'views/nuevo-footer.html';
	$rootScope.titulo = 'Productos';
	$rootScope.nuevo = "producto";
    ...
    $scope.muestraProducto = function(data){
        $location.path('/producto/'+data[0]);
    }
...
productosCtrl.$inject = ['$scope', '$rootScope', 'Productos', '$location', 'DTOptionsBuilder', 'DTColumnBuilder'];
