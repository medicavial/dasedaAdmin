...
function provedoresCtrl($scope, $rootScope, Provedores, $location, DTOptionsBuilder, DTColumnBuilder) {

	$scope.pageClass = 'page-item';
	$rootScope.footer = 'views/nuevo-footer.html';
	$rootScope.titulo = 'Proveedores';
	$rootScope.nuevo = "provedor";
...
provedoresCtrl.$inject = ['$scope', '$rootScope', 'Provedores', '$location', 'DTOptionsBuilder', 'DTColumnBuilder'];

//asignamos a la aplicacion la funcion
app.controller('provedoresCtrl', provedoresCtrl);
