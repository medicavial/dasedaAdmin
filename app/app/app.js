var conexion;
var descripcion;
var api = "http://localhost/laravel/public/api/";
...
app.run(['$rootScope','$location', 'sesion' ,'$cookies','webStorage','$window', 'Fullscreen' ,function ($rootScope , $location, sesion, $cookies, webStorage, $window, Fullscreen){    
