...
function productoCtrl($scope, $rootScope, $location, Provedores, Categorias, Marcas, Productos, webStorage, $upload) {
...
productoCtrl.$inject = ['$scope', '$rootScope', '$location', 'Provedores', 'Categorias','Marcas','Productos',  'webStorage', '$upload'];
