...
function clienteEditCtrl($scope, $rootScope, $location, Clientes,  webStorage, $routeParams) {
    ...
    $rootScope.guardar = function(){
    	...
    	if ($scope.clienteForm.$valid) {
            ...
            $rootScope.guardando = true;
                ...
                Clientes.update({id:$routeParams.id},$scope.datos,function (data){
...
clienteEditCtrl.$inject = ['$scope', '$rootScope', '$location' , 'Clientes',  'webStorage' , '$routeParams'];
